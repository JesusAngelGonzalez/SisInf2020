        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <div class="card shadow mb-4"><button class="btn btn-danger btn-lg" type="submit">Registrar Positivo</button></div>
                        </div>
                        <div class="col">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col mr-2">
                                                <h6 class="mb-0"><strong>Bar PEPE</strong></h6><span class="text-xs" style="margin-right: 10px;">03/11/2020</span><span class="text-xs">10:30 AM</span></div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
