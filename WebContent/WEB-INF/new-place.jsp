        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="new-place.jsp"><i class="far fa-building"></i><span>Añadir Lugar</span></a></li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form>
                        ...
                        <div class="form-group"><label for="Lugar">Información Extra</label><input class="form-control" type="text" name="Lugar" value="No había nadie" placeholder="Lugar"></div>
                        <div class="form-row">
