        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="newPlace"><i class="far fa-building"></i><span>Añadir Lugar</span></a></li>
                ...
                <div class="container-fluid">
                    ...
                    <form class="user" method="post" action="newPlace">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col"><label>Llegada</label><input class="form-control" type="datetime-local" required="" placeholder="a�o-mes-dia"name="Inicio"></div>
                                <div class="col"><label>Salida</label><input class="form-control" type="datetime-local" required="" placeholder = "a�o-mes-dia"name="Fin"></div>
                            </div>
                        </div>
