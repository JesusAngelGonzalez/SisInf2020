...
<head>
    ...
    <%@ page import="java.util.List,es.covid_free.model.LugaresVO"%>
    <meta charset="utf-8">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <div class="card shadow mb-4"><form ></form method="get" action="positivo"><button class="btn btn-danger btn-lg" type="submit">Registrar Positivo</button></form></div>
                        </div>
                        <div class="col">
                            <div class="card shadow mb-4"><a class="btn btn-primary btn-lg" role="button" href="new-place.jsp">Añadir Lugar</a></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            List<LugaresVO> lista = (List<LugaresVO>) request.getAttribute("listaLugares"); 
                            if (lista!=null){
                                		%>
                            <div class="card shadow mb-4">
                                ...
                                <ul class="list-group list-group-flush">
                                	<%
                                		for(LugaresVO elemento: lista){
                                	%>
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col mr-2">
                                                <h6 class="mb-0"><strong><%= elemento.getNombre() %></strong></h6> - <span><%= elemento.getUbicacion() %></span><span class="text-xs" style="margin-right: 10px;">03/11/2020</span></div>
                                        </div>
                                    </li>
                                    <%
                                		}
